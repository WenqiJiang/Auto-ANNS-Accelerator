...
#    python ../../auto_perf_test/auto_perf_test_2021.2.py --dbname Deep100M --topK 1 --use_recall_goal 0 --nlist_min 1024 --nlist_max 65536 --FPGA_num 1 --bank_num 12 --recall_dict_dir '../../auto_perf_test/cpu_recall_index_nprobe_pairs_Deep100M.pkl' --FPGA_perf_dict_dir '../../auto_perf_test/FPGA_perf_dict_Deep100M_K_1.pkl' --overwrite 1 > log_Deep100M
...
xilinx_u55c_gen3x16_xdma_base_3-0,vadd_1,vadd,1:1:1,1:1:1,1,Yes,1,1.000000x,622.33,622.331,622.33,622.331,140,
    """
...
for index_key in d_recall[dbname]:
    ...
    if use_recall_goal:
        if d_recall[dbname][index_key][topK][recall_goal] is not None:
            ...
            cmd = "./host xclbin/vadd.hw.xclbin {nlist} {nprobe} {OPQ_enable} {data_dir} /mnt/scratch/wenqi/saved_npy_data/Deep_gnd".format(
