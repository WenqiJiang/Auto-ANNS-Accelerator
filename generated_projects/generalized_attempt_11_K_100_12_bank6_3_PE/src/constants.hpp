...
#define PE_NUM_CENTER_DIST_COMP 3

#define PE_NUM_CENTER_DIST_COMP_EVEN 2
#define CENTROIDS_PER_PARTITION_EVEN_MAX 21846
#define CENTROIDS_PER_PARTITION_LAST_PE_MAX 21844
...
#define STAGE_6_PRIORITY_QUEUE_L1_NUM 12
