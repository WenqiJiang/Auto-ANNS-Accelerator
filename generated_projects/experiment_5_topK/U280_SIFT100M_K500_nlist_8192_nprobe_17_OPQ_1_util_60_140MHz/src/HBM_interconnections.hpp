...
// #pragma HLS RESOURCE variable=s_single_PQ_per_channel core=FIFO_SRL
    ...
    merge_HBM_channel_PQ_codes_5_in_1(
        ...
        s_single_PQ_per_channel[0 * 5],
        s_single_PQ_per_channel[0 * 5 + 1],
        s_single_PQ_per_channel[0 * 5 + 2],
        s_single_PQ_per_channel[0 * 5 + 3],
        s_single_PQ_per_channel[0 * 5 + 4],
        s_single_PQ[0]);
    merge_HBM_channel_PQ_codes_5_in_1(
        query_num,
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[1],
        s_single_PQ_per_channel[1 * 5],
        s_single_PQ_per_channel[1 * 5 + 1],
        s_single_PQ_per_channel[1 * 5 + 2],
        s_single_PQ_per_channel[1 * 5 + 3],
        s_single_PQ_per_channel[1 * 5 + 4],
        s_single_PQ[1]);
}
