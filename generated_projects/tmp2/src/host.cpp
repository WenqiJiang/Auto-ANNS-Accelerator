...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    size_t HBM_centroid_vectors0_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors1_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors2_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors3_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors4_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors5_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors6_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors7_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors8_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors9_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors10_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors11_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors12_len = centroids_per_partition_even * D * sizeof(float) / sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors13_len = centroids_per_partition_last * D * sizeof(float) / sizeof(ap_uint512_t);
    ...
    size_t HBM_centroid_vectors6_size =  HBM_centroid_vectors6_len * sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors7_size =  HBM_centroid_vectors7_len * sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors8_size =  HBM_centroid_vectors8_len * sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors9_size =  HBM_centroid_vectors9_len * sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors10_size =  HBM_centroid_vectors10_len * sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors11_size =  HBM_centroid_vectors11_len * sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors12_size =  HBM_centroid_vectors12_len * sizeof(ap_uint512_t);
    size_t HBM_centroid_vectors13_size =  HBM_centroid_vectors13_len * sizeof(ap_uint512_t);
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors6(HBM_centroid_vectors6_len, 0);
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors7(HBM_centroid_vectors7_len, 0);
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors8(HBM_centroid_vectors8_len, 0);
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors9(HBM_centroid_vectors9_len, 0);
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors10(HBM_centroid_vectors10_len, 0);
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors11(HBM_centroid_vectors11_len, 0);
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors12(HBM_centroid_vectors12_len, 0);
    std::vector<ap_uint512_t, aligned_allocator<ap_uint512_t>> HBM_centroid_vectors13(HBM_centroid_vectors13_len, 0);
...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    int HBM_centroid_vectors_start_addr_0 = 0 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors0[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_0, HBM_centroid_vectors0_size);

    int HBM_centroid_vectors_start_addr_1 = 1 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors1[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_1, HBM_centroid_vectors1_size);

    int HBM_centroid_vectors_start_addr_2 = 2 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors2[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_2, HBM_centroid_vectors2_size);

    int HBM_centroid_vectors_start_addr_3 = 3 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors3[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_3, HBM_centroid_vectors3_size);

    int HBM_centroid_vectors_start_addr_4 = 4 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors4[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_4, HBM_centroid_vectors4_size);

    int HBM_centroid_vectors_start_addr_5 = 5 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors5[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_5, HBM_centroid_vectors5_size);

    int HBM_centroid_vectors_start_addr_6 = 6 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors6[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_6, HBM_centroid_vectors6_size);

    int HBM_centroid_vectors_start_addr_7 = 7 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors7[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_7, HBM_centroid_vectors7_size);

    int HBM_centroid_vectors_start_addr_8 = 8 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors8[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_8, HBM_centroid_vectors8_size);

    int HBM_centroid_vectors_start_addr_9 = 9 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors9[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_9, HBM_centroid_vectors9_size);

    int HBM_centroid_vectors_start_addr_10 = 10 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors10[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_10, HBM_centroid_vectors10_size);

    int HBM_centroid_vectors_start_addr_11 = 11 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors11[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_11, HBM_centroid_vectors11_size);

    int HBM_centroid_vectors_start_addr_12 = 12 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors12[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_12, HBM_centroid_vectors12_size);

    int HBM_centroid_vectors_start_addr_13 = 13 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors13[0], HBM_vector_quantizer_char + HBM_centroid_vectors_start_addr_13, HBM_centroid_vectors13_size);
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    cl_mem_ext_ptr_t 
        ...
        HBM_centroid_vectors6Ext,
        HBM_centroid_vectors7Ext,
        HBM_centroid_vectors8Ext,
        HBM_centroid_vectors9Ext,
        HBM_centroid_vectors10Ext,
        HBM_centroid_vectors11Ext,
        HBM_centroid_vectors12Ext,
        HBM_centroid_vectors13Ext,
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    HBM_centroid_vectors0Ext.flags = bank[9];
    HBM_centroid_vectors1Ext.obj = HBM_centroid_vectors1.data();
    HBM_centroid_vectors1Ext.param = 0;
    HBM_centroid_vectors1Ext.flags = bank[10];
    HBM_centroid_vectors2Ext.obj = HBM_centroid_vectors2.data();
    HBM_centroid_vectors2Ext.param = 0;
    HBM_centroid_vectors2Ext.flags = bank[11];
    HBM_centroid_vectors3Ext.obj = HBM_centroid_vectors3.data();
    HBM_centroid_vectors3Ext.param = 0;
    HBM_centroid_vectors3Ext.flags = bank[12];
    HBM_centroid_vectors4Ext.obj = HBM_centroid_vectors4.data();
    HBM_centroid_vectors4Ext.param = 0;
    HBM_centroid_vectors4Ext.flags = bank[13];
    HBM_centroid_vectors5Ext.obj = HBM_centroid_vectors5.data();
    HBM_centroid_vectors5Ext.param = 0;
    HBM_centroid_vectors5Ext.flags = bank[14];
    HBM_centroid_vectors6Ext.obj = HBM_centroid_vectors6.data();
    HBM_centroid_vectors6Ext.param = 0;
    HBM_centroid_vectors6Ext.flags = bank[15];
    HBM_centroid_vectors7Ext.obj = HBM_centroid_vectors7.data();
    HBM_centroid_vectors7Ext.param = 0;
    HBM_centroid_vectors7Ext.flags = bank[16];
    HBM_centroid_vectors8Ext.obj = HBM_centroid_vectors8.data();
    HBM_centroid_vectors8Ext.param = 0;
    HBM_centroid_vectors8Ext.flags = bank[17];
    HBM_centroid_vectors9Ext.obj = HBM_centroid_vectors9.data();
    HBM_centroid_vectors9Ext.param = 0;
    HBM_centroid_vectors9Ext.flags = bank[18];
    HBM_centroid_vectors10Ext.obj = HBM_centroid_vectors10.data();
    HBM_centroid_vectors10Ext.param = 0;
    HBM_centroid_vectors10Ext.flags = bank[19];
    HBM_centroid_vectors11Ext.obj = HBM_centroid_vectors11.data();
    HBM_centroid_vectors11Ext.param = 0;
    HBM_centroid_vectors11Ext.flags = bank[20];
    HBM_centroid_vectors12Ext.obj = HBM_centroid_vectors12.data();
    HBM_centroid_vectors12Ext.param = 0;
    HBM_centroid_vectors12Ext.flags = bank[21];
    HBM_centroid_vectors13Ext.obj = HBM_centroid_vectors13.data();
    HBM_centroid_vectors13Ext.param = 0;
    HBM_centroid_vectors13Ext.flags = bank[22];
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors6(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors6_size, &HBM_centroid_vectors6Ext, &err));
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors7(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors7_size, &HBM_centroid_vectors7Ext, &err));
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors8(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors8_size, &HBM_centroid_vectors8Ext, &err));
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors9(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors9_size, &HBM_centroid_vectors9Ext, &err));
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors10(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors10_size, &HBM_centroid_vectors10Ext, &err));
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors11(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors11_size, &HBM_centroid_vectors11Ext, &err));
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors12(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors12_size, &HBM_centroid_vectors12Ext, &err));
    OCL_CHECK(err, cl::Buffer buffer_HBM_centroid_vectors13(context, CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, 
            HBM_centroid_vectors13_size, &HBM_centroid_vectors13Ext, &err));
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors5));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors6));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors7));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors8));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors9));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors10));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors11));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors12));
    OCL_CHECK(err, err = krnl_vector_add.setArg(arg_counter++, buffer_HBM_centroid_vectors13));
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    OCL_CHECK(
        ...
        buffer_HBM_centroid_vectors6,
        buffer_HBM_centroid_vectors7,
        buffer_HBM_centroid_vectors8,
        buffer_HBM_centroid_vectors9,
        buffer_HBM_centroid_vectors10,
        buffer_HBM_centroid_vectors11,
        buffer_HBM_centroid_vectors12,
        buffer_HBM_centroid_vectors13,
