...
void vadd(  
    ...
    const ap_uint512_t* HBM_centroid_vectors_stage2_8,
    const ap_uint512_t* HBM_centroid_vectors_stage2_9,
    const ap_uint512_t* HBM_centroid_vectors_stage2_10,
    const ap_uint512_t* HBM_centroid_vectors_stage2_11,
    const ap_uint512_t* HBM_centroid_vectors_stage2_12,
    const ap_uint512_t* HBM_centroid_vectors_stage2_13,
...
#pragma HLS INTERFACE m_axi port=HBM_centroid_vectors_stage2_8  offset=slave bundle=gmemC8
#pragma HLS INTERFACE m_axi port=HBM_centroid_vectors_stage2_9  offset=slave bundle=gmemC9
#pragma HLS INTERFACE m_axi port=HBM_centroid_vectors_stage2_10  offset=slave bundle=gmemC10
#pragma HLS INTERFACE m_axi port=HBM_centroid_vectors_stage2_11  offset=slave bundle=gmemC11
#pragma HLS INTERFACE m_axi port=HBM_centroid_vectors_stage2_12  offset=slave bundle=gmemC12
#pragma HLS INTERFACE m_axi port=HBM_centroid_vectors_stage2_13  offset=slave bundle=gmemC13
...
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_stage2_8
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_stage2_9
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_stage2_10
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_stage2_11
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_stage2_12
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_stage2_13
...
// #pragma HLS resource variable=s_merged_cell_distance core=FIFO_BRAM
    ...
    compute_cell_distance_wrapper<QUERY_NUM>(
        ...
        HBM_centroid_vectors_stage2_8,
        HBM_centroid_vectors_stage2_9,
        HBM_centroid_vectors_stage2_10,
        HBM_centroid_vectors_stage2_11,
        HBM_centroid_vectors_stage2_12,
        HBM_centroid_vectors_stage2_13,
