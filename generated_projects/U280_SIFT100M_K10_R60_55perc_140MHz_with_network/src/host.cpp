...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    std::ifstream HBM_embedding0_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_0_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding1_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_1_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding2_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_2_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding3_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_3_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding4_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_4_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding5_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_5_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding6_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_6_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding7_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_7_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding8_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_8_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding9_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_9_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding10_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_10_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding11_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_11_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding12_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_12_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding13_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_13_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding14_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_14_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding15_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_15_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding16_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_16_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding17_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_17_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding18_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_18_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding19_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_19_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding20_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_20_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding21_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_21_raw", 
        std::ios::in | std::ios::binary);
    std::ifstream HBM_embedding22_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_bank_22_raw", 
        std::ios::in | std::ios::binary);
...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    std::ifstream HBM_info_start_addr_and_scanned_entries_every_cell_and_last_element_valid_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/HBM_info_start_addr_and_scanned_entries_every_cell_and_last_element_valid_3_by_4096_raw", 
        std::ios::in | std::ios::binary);

    std::ifstream HBM_query_vector_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/query_vectors_float32_10000_128_raw", 
        std::ios::in | std::ios::binary);

    std::ifstream HBM_vector_quantizer_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/vector_quantizer_float32_4096_128_raw", 
        std::ios::in | std::ios::binary);

    std::ifstream HBM_product_quantizer_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/product_quantizer_float32_16_256_8_raw", 
        std::ios::in | std::ios::binary);

#ifdef OPQ_ENABLE
    std::ifstream HBM_OPQ_matrix_fstream(
        "/mnt/scratch/wenqi/saved_npy_data/FPGA_data_SIFT100M_IVF4096,PQ16_23_banks/OPQ_matrix_float32_128_128_raw", 
        std::ios::in | std::ios::binary);
