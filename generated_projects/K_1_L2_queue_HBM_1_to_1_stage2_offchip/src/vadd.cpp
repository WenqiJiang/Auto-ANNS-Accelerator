...
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_0
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_1
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_2
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_3
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_4
#pragma HLS INTERFACE s_axilite port=HBM_centroid_vectors_5
