...
// #pragma HLS RESOURCE variable=s_single_PQ_per_channel core=FIFO_SRL
    ...
    load_and_split_PQ_codes<query_num>(
        ...
        s_single_PQ_per_channel[15]);
    merge_HBM_channel_PQ_codes_4_in_1<query_num>(
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[0],
        s_single_PQ_per_channel[0 * 4],
        s_single_PQ_per_channel[0 * 4 + 1],
        s_single_PQ_per_channel[0 * 4 + 2],
        s_single_PQ_per_channel[0 * 4 + 3],
        s_single_PQ[0]);
    merge_HBM_channel_PQ_codes_4_in_1<query_num>(
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[1],
        s_single_PQ_per_channel[1 * 4],
        s_single_PQ_per_channel[1 * 4 + 1],
        s_single_PQ_per_channel[1 * 4 + 2],
        s_single_PQ_per_channel[1 * 4 + 3],
        s_single_PQ[1]);
    merge_HBM_channel_PQ_codes_4_in_1<query_num>(
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[2],
        s_single_PQ_per_channel[2 * 4],
        s_single_PQ_per_channel[2 * 4 + 1],
        s_single_PQ_per_channel[2 * 4 + 2],
        s_single_PQ_per_channel[2 * 4 + 3],
        s_single_PQ[2]);
    merge_HBM_channel_PQ_codes_4_in_1<query_num>(
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[3],
        s_single_PQ_per_channel[3 * 4],
        s_single_PQ_per_channel[3 * 4 + 1],
        s_single_PQ_per_channel[3 * 4 + 2],
        s_single_PQ_per_channel[3 * 4 + 3],
        s_single_PQ[3]);
}
