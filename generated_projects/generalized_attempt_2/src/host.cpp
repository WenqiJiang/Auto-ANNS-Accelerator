...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    fs::path HBM_embedding0_dir_path("/");
    ...
    fs::path HBM_embedding1_dir_path ("/");
    ...
    fs::path HBM_embedding2_dir_path("/");
    ...
    fs::path HBM_embedding3_dir_path ("/");
    ...
    fs::path HBM_embedding4_dir_path ("/");
    ...
    fs::path HBM_embedding5_dir_path ("/");
    ...
    fs::path HBM_embedding6_dir_path ("/");
    ...
    fs::path HBM_embedding7_dir_path ("/");
    ...
    fs::path HBM_embedding8_dir_path ("/");
    ...
    fs::path HBM_embedding9_dir_path ("/");
    ...
    fs::path HBM_embedding10_dir_path ("/");
    ...
    fs::path HBM_embedding11_dir_path ("/");
    ...
    fs::path HBM_embedding12_dir_path ("/");
    ...
    fs::path HBM_embedding13_dir_path ("/");
    ...
    fs::path HBM_embedding14_dir_path ("/");
    ...
    fs::path HBM_embedding15_dir_path ("/");
...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    //fs::path HBM_info_start_addr_and_scanned_entries_every_cell_and_last_element_valid_dir_path = data_dir_prefix_path + HBM_info_start_addr_and_scanned_entries_every_cell_and_last_element_valid_dir_suffix_path;
    ...
    fs::path HBM_vector_quantizer_dir_path ("/");
    ...
    fs::path HBM_product_quantizer_dir_path ("/");
    ...
    fs::path HBM_OPQ_matrix_dir_path ("/");
    ...
    fs::path raw_gt_vec_ID_dir_path ("/");
