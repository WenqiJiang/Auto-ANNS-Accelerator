...
#pragma HLS array_partition variable=s_cell_ID complete
    ...
    load_vector_quantizer_from_HBM(
        ...
        s_HBM_centroid_vectors[4 * 2 + 1],
        s_cell_ID[4 * 2],
        s_cell_ID[4 * 2 + 1]);

    int start_cell_ID_load_5 = 5 * 2 * centroids_per_partition_even;
    load_vector_quantizer_from_HBM(
        query_num,
        start_cell_ID_load_5,
        centroids_per_partition_even,
        centroids_per_partition_even,
        HBM_centroid_vectors_stage2_5,
        s_HBM_centroid_vectors[5 * 2],
        s_HBM_centroid_vectors[5 * 2 + 1],
        s_cell_ID[5 * 2],
        s_cell_ID[5 * 2 + 1]);

    int start_cell_ID_load_6 = 6 * 2 * centroids_per_partition_even;
    load_vector_quantizer_from_HBM(
        query_num,
        start_cell_ID_load_6,
        centroids_per_partition_even,
        centroids_per_partition_even,
        HBM_centroid_vectors_stage2_6,
        s_HBM_centroid_vectors[6 * 2],
        s_HBM_centroid_vectors[6 * 2 + 1],
        s_cell_ID[6 * 2],
        s_cell_ID[6 * 2 + 1]);

    int start_cell_ID_load_7 = 7 * 2 * centroids_per_partition_even;
    load_vector_quantizer_from_HBM(
        query_num,
        start_cell_ID_load_7,
        centroids_per_partition_even,
        centroids_per_partition_last_PE,
        HBM_centroid_vectors_stage2_7,
        s_HBM_centroid_vectors[7 * 2],
        s_HBM_centroid_vectors[7 * 2 + 1],
        s_cell_ID[7 * 2],
        s_cell_ID[7 * 2 + 1]);
    ...
    // middle
        ...
        compute_cell_distance_middle_PE(
            ...
            centroids_per_partition, 
            total_centriods,
            s_HBM_centroid_vectors[11],
            s_cell_ID[11],
            s_query_vectors_forward[11 - 1],
            s_query_vectors_forward[11],
            s_partial_cell_distance_forward[11 - 1],
            s_partial_cell_distance_forward[11]);
        ...
        compute_cell_distance_middle_PE(
            ...
            centroids_per_partition, 
            total_centriods,
            s_HBM_centroid_vectors[12],
            s_cell_ID[12],
            s_query_vectors_forward[12 - 1],
            s_query_vectors_forward[12],
            s_partial_cell_distance_forward[12 - 1],
            s_partial_cell_distance_forward[12]);
        ...
        compute_cell_distance_middle_PE(
            ...
            centroids_per_partition, 
            total_centriods,
            s_HBM_centroid_vectors[13],
            s_cell_ID[13],
            s_query_vectors_forward[13 - 1],
            s_query_vectors_forward[13],
            s_partial_cell_distance_forward[13 - 1],
            s_partial_cell_distance_forward[13]);
        ...
        compute_cell_distance_middle_PE(
            ...
            centroids_per_partition, 
            total_centriods,
            s_HBM_centroid_vectors[14],
            s_cell_ID[14],
            s_query_vectors_forward[14 - 1],
            s_query_vectors_forward[14],
            s_partial_cell_distance_forward[14 - 1],
            s_partial_cell_distance_forward[14]);
