...
#pragma HLS pipeline II=1
                ...
                ap_uint512_t cell_centroids_uint = HBM_centroid_vectors[0];
...
void load_vector_quantizer_from_HBM_component_B(
    ...
    for (int query_id = 0; query_id < query_num; query_id++) {
        ...
        // compute distance and write results out
        for (int c = 0; c < centroids_per_partition_B; c++) {
...
#pragma HLS inline
    ...
    hls::stream<ap_uint512_t> s_HBM_centroid_vectors;
#pragma HLS stream variable=s_HBM_centroid_vectors depth=512
