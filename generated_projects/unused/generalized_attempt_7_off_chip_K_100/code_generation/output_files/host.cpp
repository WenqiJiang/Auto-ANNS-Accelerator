...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    size_t HBM_centroid_vectors13_len = centroids_per_partition_last_PE * D * sizeof(float) / sizeof(ap_uint512_t);
...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    int HBM_centroid_vectors_stage2_start_addr_0 = 0 * centroids_per_partition_even * D * sizeof(float);
    ...
    int HBM_centroid_vectors_stage2_start_addr_1 = 1 * centroids_per_partition_even * D * sizeof(float);
    ...
    int HBM_centroid_vectors_stage2_start_addr_2 = 2 * centroids_per_partition_even * D * sizeof(float);
    ...
    int HBM_centroid_vectors_stage2_start_addr_3 = 3 * centroids_per_partition_even * D * sizeof(float);
    ...
    int HBM_centroid_vectors_stage2_start_addr_4 = 4 * centroids_per_partition_even * D * sizeof(float);
    ...
    int HBM_centroid_vectors_stage2_start_addr_5 = 5 * centroids_per_partition_even * D * sizeof(float);
    ...
    int HBM_centroid_vectors_stage2_start_addr_6 = 6 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors6[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_6, HBM_centroid_vectors6_size);

    int HBM_centroid_vectors_stage2_start_addr_7 = 7 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors7[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_7, HBM_centroid_vectors7_size);

    int HBM_centroid_vectors_stage2_start_addr_8 = 8 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors8[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_8, HBM_centroid_vectors8_size);

    int HBM_centroid_vectors_stage2_start_addr_9 = 9 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors9[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_9, HBM_centroid_vectors9_size);

    int HBM_centroid_vectors_stage2_start_addr_10 = 10 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors10[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_10, HBM_centroid_vectors10_size);

    int HBM_centroid_vectors_stage2_start_addr_11 = 11 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors11[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_11, HBM_centroid_vectors11_size);

    int HBM_centroid_vectors_stage2_start_addr_12 = 12 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors12[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_12, HBM_centroid_vectors12_size);

    int HBM_centroid_vectors_stage2_start_addr_13 = 13 * centroids_per_partition_even * D * sizeof(float);
    memcpy(&HBM_centroid_vectors13[0], HBM_vector_quantizer_char + HBM_centroid_vectors_stage2_start_addr_13, HBM_centroid_vectors13_size);
