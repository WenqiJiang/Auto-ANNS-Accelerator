...
// #pragma HLS RESOURCE variable=s_single_PQ_per_channel core=FIFO_SRL
    ...
    merge_HBM_channel_PQ_codes_2_in_1(
        query_num,
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[5],
        s_single_PQ_per_channel[5 * 2],
        s_single_PQ_per_channel[5 * 2 + 1],
        s_single_PQ[5]);
    merge_HBM_channel_PQ_codes_2_in_1(
        query_num,
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[6],
        s_single_PQ_per_channel[6 * 2],
        s_single_PQ_per_channel[6 * 2 + 1],
        s_single_PQ[6]);
    merge_HBM_channel_PQ_codes_2_in_1(
        query_num,
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[7],
        s_single_PQ_per_channel[7 * 2],
        s_single_PQ_per_channel[7 * 2 + 1],
        s_single_PQ[7]);
}
