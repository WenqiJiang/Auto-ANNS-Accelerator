...
// #pragma HLS RESOURCE variable=s_single_PQ_per_channel core=FIFO_SRL
    ...
    merge_HBM_channel_PQ_codes_9_in_1(
        ...
        s_single_PQ_per_channel[0 * 9],
        s_single_PQ_per_channel[0 * 9 + 1],
        s_single_PQ_per_channel[0 * 9 + 2],
        s_single_PQ_per_channel[0 * 9 + 3],
        s_single_PQ_per_channel[0 * 9 + 4],
        s_single_PQ_per_channel[0 * 9 + 5],
        s_single_PQ_per_channel[0 * 9 + 6],
        s_single_PQ_per_channel[0 * 9 + 7],
        s_single_PQ_per_channel[0 * 9 + 8],
        s_single_PQ[0]);
}
