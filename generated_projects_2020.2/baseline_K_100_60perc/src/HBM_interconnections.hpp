...
// #pragma HLS RESOURCE variable=s_single_PQ_per_channel core=FIFO_SRL
    ...
    merge_HBM_channel_PQ_codes_3_in_1<query_num>(
        ...
        s_single_PQ_per_channel[0 * 3],
        s_single_PQ_per_channel[0 * 3 + 1],
        s_single_PQ_per_channel[0 * 3 + 2],
        s_single_PQ[0]);
    merge_HBM_channel_PQ_codes_3_in_1<query_num>(
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[1],
        s_single_PQ_per_channel[1 * 3],
        s_single_PQ_per_channel[1 * 3 + 1],
        s_single_PQ_per_channel[1 * 3 + 2],
        s_single_PQ[1]);
    merge_HBM_channel_PQ_codes_3_in_1<query_num>(
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[2],
        s_single_PQ_per_channel[2 * 3],
        s_single_PQ_per_channel[2 * 3 + 1],
        s_single_PQ_per_channel[2 * 3 + 2],
        s_single_PQ[2]);
    merge_HBM_channel_PQ_codes_3_in_1<query_num>(
        nprobe,
        s_scanned_entries_every_cell_Merge_unit_replicated[3],
        s_single_PQ_per_channel[3 * 3],
        s_single_PQ_per_channel[3 * 3 + 1],
        s_single_PQ_per_channel[3 * 3 + 2],
        s_single_PQ[3]);
}
