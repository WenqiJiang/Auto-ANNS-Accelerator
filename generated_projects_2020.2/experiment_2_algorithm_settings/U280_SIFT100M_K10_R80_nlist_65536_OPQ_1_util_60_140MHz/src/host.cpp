...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    size_t HBM_centroid_vectors7_len = (centroids_per_partition_even + centroids_per_partition_last_PE) * D * sizeof(float) / sizeof(ap_uint512_t);
