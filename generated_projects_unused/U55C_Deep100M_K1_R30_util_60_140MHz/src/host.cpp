...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    size_t HBM_query_vector_len = query_num * D < 10000 * D? query_num * D: 10000 * D;
    size_t HBM_vector_quantizer_len = nlist * D;
    size_t HBM_product_quantizer_len = 16 * 256 * (D / 16);
...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    std::cout << "6\n" << std::endl;
        std::string raw_gt_vec_ID_suffix_dir = "gt_idx_100M.ibin";
